...
# Tracking de mudancas no reprocess (Frente 2)
cur.execute("ALTER TABLE revisoes_em_andamento ADD COLUMN IF NOT EXISTS valor_anterior NUMERIC")
cur.execute("ALTER TABLE revisoes_em_andamento ADD COLUMN IF NOT EXISTS reprocessado_em TIMESTAMPTZ")
